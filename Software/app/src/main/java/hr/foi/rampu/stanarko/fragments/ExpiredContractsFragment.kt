 ...
 * Use the [ExpiredContractsFragment.newInstance] factory method to
...
class ExpiredContractsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ExpiredContractsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ExpiredContractsFragment().apply {
